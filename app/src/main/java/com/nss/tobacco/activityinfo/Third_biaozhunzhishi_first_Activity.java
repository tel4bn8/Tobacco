...
public class Third_biaozhunzhishi_first_Activity extends AppCompatActivity implements OnPageChangeListener
        , OnLoadCompleteListener, OnDrawListener ,View.OnClickListener{
    private PDFView pdfView ;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_third_biaozhunzhishi_first);
        TextView textView = (TextView) findViewById(R.id.textView_item);
        textView.setText("办公室主任岗位说明书");
        ImageView iv = (ImageView) findViewById(R.id.back_item);
        iv.setOnClickListener(this);
        pdfView = (PDFView) findViewById( R.id.pdfView );
        //从assets目录读取pdf
        displayFromAssets("biaozhunzhishiku.pdf");
       /* //从文件中读取pdf
