...
@ContentView(R.layout.activity_add__dongguan)
public class Add_DongguanActivity extends AppCompatActivity implements View.OnClickListener{


    private Sec_DongGuanDao mDao;
    Context mContext;
    ...
    @ViewInject(R.id.second_zdql_dongguan_add_phone_addmsg)
    ImageView take_photo;

    @ViewInject(R.id.second_zdql_dongguan_add_farmer)
    Spinner sp_farmer;

    @ViewInject(R.id.second_zdql_dongguan_add_createtime)
    TextView text_createtime;
    @ViewInject(R.id.second_zdql_dongguan_add_area)
    EditText mianji;
    @ViewInject(R.id.biaozhun_pic)
    ImageView biaozhun;
    @ViewInject(R.id.second_zdql_dongguan_add_detail)
    EditText edit_detail;
    @ViewInject(R.id.second_zdql_dongguan_add_btnSave)
    Button save;
    @ViewInject(R.id.second_zdql_dongguan_add_btnBack)
    Button back_btn;

    @ViewInject(R.id.second_zdql_dongguan_add_gridView)
    GridView gvPhoto;
    @Override
    ...
    private void initCareme() {
        ...
        mDao=new Sec_DongGuanDao(mContext);
        ...
        if (getIntent().getStringExtra("folderName") == null) {
            photoFolderPath = CommonUtil.getSDPath() + File.separator + "DongGuan";
        } else {
    ...
    private void setDate() {
        ...
        text_createtime.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                DateDialog dialog = new DateDialog(Add_DongguanActivity.this);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.back_item:
                myDialog();
                break;
            case R.id.second_zdql_dongguan_add_phone_addmsg:
                //判断是否安装SD卡
                ...
                break;
            case R.id.second_zdql_dongguan_add_btnSave:

                saveInfo();
                finish();
                break;
            case R.id.second_zdql_dongguan_add_btnBack:
                myDialog();
                break;
            default:
                break;
    ...
    private void saveInfo() {
        ...
        Sec_DongGuanEntity info = new Sec_DongGuanEntity();
