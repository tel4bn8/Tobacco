...
public class YnHetongAddActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    //拍照
    Context context;
    private static final int CRAEMA_REQUEST_CODE = 7; //拍照请求码
    ...
    @ViewInject(R.id.frm_first_yn_hetong_add_caremaView)
    ...
    @ViewInject(R.id.frm_first_yn_htgl_add_spinner_yanyeType)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        x.view().inject(this);
        context = this;
        hetongGuanliDao = new HetongGuanliDao(context);
    ...
    private void initCarema() {
        ...
        if(getIntent().getStringExtra("folderName") == null){
            photoFolderAddress = CommonUtil.getSDPath() + File.separator + "hetongguanli";
        }else{
    ...
    private void saveInfo() {
        ...
        ArrayList<HetongGuanli> hetongList = new ArrayList<>();
        HetongGuanli mHetongGuanli = new HetongGuanli();

        mHetongGuanli.setId(IdUtil.getId());
        mHetongGuanli.setCode(etHetongID.getText().toString());
        mHetongGuanli.setYear(spQianyueniandu.getSelectedItem().toString());
        mHetongGuanli.setFarmer(spYannongName.getSelectedItem().toString());
        mHetongGuanli.setType(spyanyeType.getSelectedItem().toString());
        mHetongGuanli.setArea1(etCaoqianmianji.getText().toString());
        mHetongGuanli.setNum1(etcaoqianNum.getText().toString());
        mHetongGuanli.setCaoqiantime(tvCaoqianTime.getText().toString());
        mHetongGuanli.setDetail(etBeizhu.getText().toString());
        mHetongGuanli.setState(state);
        mHetongGuanli.setPhotopath(photoPath.toString());

        hetongList.add(mHetongGuanli);
        hetongGuanliDao.add(mHetongGuanli);
    }
