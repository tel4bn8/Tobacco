...
public class YmhYumaioAddActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    @ViewInject(R.id.frm_first_ymh_ymh_add_caremaView)
    ...
    @ViewInject(R.id.frm_first_ymh_ymh_add_spinner_yumiaodian)
    private Spinner spYumiaogongchang;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        x.view().inject(this);
        context = this;
        yumiaohuDao = new YumiaohuDao(context);
    ...
    private void initCarema() {
        ...
        if(getIntent().getStringExtra("folderName") == null){
            photoFolderAddress = CommonUtil.getSDPath() + File.separator + "yumiaohu";
        }else{
    ...
    private void mySpinner() {
        ...
        spYumiaogongchang.setAdapter(adapter3);
    ...
    private void saveInfo() {
        ...
        ArrayList<Yumiaohu> yumiaohuList = new ArrayList<>();
        Yumiaohu mYumiaohu = new Yumiaohu();

        mYumiaohu.setId(IdUtil.getId());
        mYumiaohu.setName(etName.getText().toString());
        mYumiaohu.setIdcard(etIDcardNum.getText().toString());
        mYumiaohu.setYear(spZhongzhiYears.getSelectedItem().toString());
        mYumiaohu.setSex(tvSex.getText().toString());
        mYumiaohu.setAge(tvAge.getText().toString());
        mYumiaohu.setEducation(spCultureLevel.getSelectedItem().toString());
        mYumiaohu.setVillage(spHomeAddress.getSelectedItem().toString());
        mYumiaohu.setPhone(etPhoneNum.getText().toString());
        mYumiaohu.setTechnician(tvYanjiyuan.getText().toString());
        mYumiaohu.setCreatetime(tvDengjiTime.getText().toString());
        mYumiaohu.setYumiaogongchangid(spYumiaogongchang.getSelectedItem().toString());
        mYumiaohu.setDetail(etBeizhu.getText().toString());
        mYumiaohu.setState(state);
        mYumiaohu.setPhotopath(photoPath.toString());

        yumiaohuList.add(mYumiaohu);
        yumiaohuDao.add(mYumiaohu);
    }
